...
![](/_static/images/mltc-image-13.png)
...
![](/_static/images/mltc-image-12.png)
...
2. 从[HuggingFace](https://huggingface.co/fcakyon/yolov5s-v7.0/tree/main)下载pt格式的权重（`yolov5s.pt`），并将权重文件移动到YOLOv5 repo所在的平级目录。
   ...
   ![](/_static/images/mltc-image-14.png)
...
6. 验证ONNX模型在CPU上的执行效果。
   ...
   ![](/_static/images/mltc-image-11.png)
...
9. 修改部分代码适配YOLOv5的repo。
   ...
   * 修改`export.py`，修改点如下：
     ...
     ![](/_static/images/mltc-image-1.png)
...
![](/_static/images/mltc-image-2.png)

![](/_static/images/mltc-image-3.png)
...
![](/_static/images/mltc-image-4.png)
...
2. 获取模型的NPU数据。
   ...
   ![](/_static/images/mltc-image-5.png)
...
4. 运行工具中的NPU数据拼接脚本，对NPU数据进行拼接。
   ...
   ![](/_static/images/mltc-image-6.png)
...
![](/_static/images/mltc-image-7.png)
...
* 错误节点对应的绝对误差和相对误差散点图（`{op_name}_diff.png`）：
  ...
  ![](/_static/images/mltc-image-8.png)

* CPU和NPU数据的直方图分布（`{op_name}_hist.png`）：

  ![](/_static/images/mltc-image-9.png)

* 相对误差和绝对误差的直方图分布（`{op_name}_diff_hist.png`）：

  ![](/_static/images/mltc-image-10.png)
...
![](/_static/images/mltc-image-15.png)
...
![](/_static/images/mltc-image-16.png)
...
* 重复/丢失节点问题
  ...
  * 重复节点问题：
  ...
  ![](/_static/images/mltc-image-19.png)

  * 丢失节点问题：

    节点名重复导致信息不一致，会出现节点丢失的现象，工具在分析过程中中会报以下错误：

    ![](/_static/images/mltc-image-20.png)

  上述两个节点问题的错误日志会记录在`result/skip_file_dict.csv`，如下所示：

  ![](/_static/images/mltc-image-21.png)
...
![](/_static/images/mltc-image-22.png)
