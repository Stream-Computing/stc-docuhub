...
![](\doc_img\mltc-image-2.png)

![](\doc_img\mltc-image-3.png)
...
* 错误节点对应的绝对误差和相对误差散点图（`{op_name}_diff.png`）：
  ...
  ![](\doc_img\mltc-image-8.png)

* CPU和NPU数据的直方图分布（`{op_name}_hist.png`）：

  ![](\doc_img\mltc-image-9.png)

* 相对误差和绝对误差的直方图分布（`{op_name}_diff_hist.png`）：

  ![](\doc_img\mltc-image-10.png)
