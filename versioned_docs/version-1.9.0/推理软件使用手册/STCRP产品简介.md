...
![](\doc_img\version-1.9.0\stcrp-image-2.png)
...
![](\doc_img\version-1.9.0\stcrp-image-3.png)

MLTC的典型编译流程如下图所示：

![](\doc_img\version-1.9.0\stcrp-image.png)

## STC\_LLM

主流的开源LLM往往基于HuggingFace的格式，权重保存为bin或者safetensors，为更高效地完成LLM推理任务，我们面向LLM自研了推理框架STC\_LLM。STC\_LLM在AI编译器、手写算子的基础上对LLM的推理过程进行了封装，您可以方便地导入、替换LLM并完成推理任务，简化了LLM的部署和使用过程。
...
![](\doc_img\version-1.9.0\stcrp-image-1.png)
