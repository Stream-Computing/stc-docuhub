...
* 吹风方向
  ...
  ![](\doc_img\version-1.9.0\s9f60MWIqjNL.png)

* 吸风方向

  ![](\doc_img\version-1.9.0\EW4J1NyWLOpD.png)
...
* 解决方法：在BIOS面板中启用`Above 4G Decoding`，如下所示：
  ...
  ![](\doc_img\version-1.9.0\img_v3_02ei_4f107f7d-e4ee-41a9-8419-40d3cd03b9dg.jpg)
...
| **操作系统版本**                                 | **Linux内核版本** | **glibc版本** | **GCC版本**                  | **dkms版本** |
| ------------------------------------------------ | ----------------- | ------------- | ---------------------------- | ------------ |
