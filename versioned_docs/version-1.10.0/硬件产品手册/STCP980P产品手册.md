...
| **规格项** | **规格说明**                                                 |
| ---------- | ------------------------------------------------------------ |
| 标识       | 型号：STCP980P<br/>产地：中国                                |
| 外观       | 尺寸：单宽、3/4长、全高（268.44mm × 111.15mm）<br/>重量：721.2 g |
| 功耗       | 功耗：150 W<br/>电源：一个PCIe 8-Pin电源连接器<br/>散热：被动散热 |
| 性能       | 核心架构：Neural Scale NPC<br/>核心频率：1 GHz<br/>最大频率：1.4 GHz<br/>半精度浮点运算速度（FP16）：167TFLOPS<br/>整数运算速度（INT8）：335TOPS |
| 内存       | 内存类型：LPDDR4X<br/>内存容量：16 GB<br/>内存位宽：256-bit<br/>内存时钟频率：1867 MHz<br/>内存带宽：108 GB/s |
| 接口       | PCIe接口：PCIe 4.0 × 16，支持Lane Reversal。<br/>PCI标识符：<br/>- PCIe Vendor ID：0x23e2<br/>- PCIe Device ID：0x0106<br/>- PCIe Sub-Vendor ID：0x23e2<br/>- PCIe Sub-System ID：0x0006<br/>CTO（PCIe Completion Timeout）功能：<br/>- 支持的range（DEVCAP2）：10 ms - 250 ms<br/>- 是否有特殊设定需求（DEVCTL2）：默认Completion Timeout值为200 ms |
