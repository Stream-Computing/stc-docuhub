...
* STCP920 AI推理加速卡基于NeuralScale架构、软硬件协同设计，可以通过标准的PCIe接口便捷地集成到各类服务器中，从而快速扩展云端推理能力，满足计算机视觉、自然语言处理、语音识别、搜索推荐、LLM等主流AI场景中的推理加速需求。
...
* STCRP：Stream Computing System Reference Platform。AI加速卡的配套软件以STCRP的形式交付，包括了异构编程引擎、AI编译器，以及满足监控调试、部署集成等用途的工具。
