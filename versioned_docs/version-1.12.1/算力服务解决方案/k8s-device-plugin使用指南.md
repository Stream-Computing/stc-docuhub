...
以在Ubuntu 22.04上构建STCRP1.12.1版本为例：
...
ARG URI
ARG HPE_REPO=hpe-repo-ubuntu2204-1-9-local_1.9.7_amd64.deb
ARG MLTC_install_file=mltc-1.6.1-cp310-cp310-linux_x86_64.whl
ARG STCNQ_install_file=stcnq-1.0.0-py3-none-any.whl
ARG STC_IE_install_file=stc_ie-1.6.1-py3-none-any.whl
